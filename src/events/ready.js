module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`Chilly has left ${guild.guild_name}`);
  }

  client.logger.info('Chilly is now online');
  client.logger.info(`Chilly is running on ${client.guilds.cache.size} server(s)`);
};
